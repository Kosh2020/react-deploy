    ...
    super();
     this.state={ mainHead:'Ты сегодня покормил кота?',
                  cardsDatas : [{cardHead1Normal: 'Сказочное заморское яство', cardHead1Hover: 'Котэ не одобряет?', with_:"с фуагра",portion:"10 порций",  present:"мышь в подарок",   numb_kg:"0,5", bottom_head_normal:"Чего сидишь? Порадуй котэ,", bottom_head_disabled:" Печалька, с фуагра закончился", bottom_head_selected:"Печень утки разварная с артишоками", isSelected:false,  isDisabled:true,},
                                ...
                                {cardHead1Normal: 'Сказочное заморское яство', cardHead1Hover: 'Котэ не одобряет?',with_:"с курой", portion:"100 порций", present:"5 мышей в подарок",numb_kg:"5", bottom_head_normal:"Чего сидишь? Порадуй котэ," , bottom_head_disabled:" Печалька, с курой закончился",   bottom_head_selected:"Филе из цыплят с трюфелями в бульоне", isSelected:false,  isDisabled:false,}],
                }
  }//constructor
